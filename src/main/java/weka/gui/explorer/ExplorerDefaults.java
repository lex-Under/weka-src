...
public class ExplorerDefaults implements Serializable {
    ...
    /**
     * returns whether the evaluation of the classifier is done
     * cost-sensitively.
     *
    ...
    /**
     * Returns the minimum size in pixels for plots of plotting classifier
     * errors of numeric attributes.
     *
     * @return the size
     */
    ...
    /**
     * returns whether the clusters are storeed for visualization purposes in
     * the cluster panel.
     *
